...
router.post('/create', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, phone, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name = _a.name, email = _a.email, phone = _a.phone;
                return [4 /*yield*/, user_model_1.default.create({ name: name, email: email, phone: phone }).then(function (data) {
...
router.put('/update/:id', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, phone, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name = _a.name, email = _a.email, phone = _a.phone;
                return [4 /*yield*/, user_model_1.default.findByIdAndUpdate({ _id: req.params.id }, { name: name, email: email, phone: phone }).then(function (data) {
...
router.delete('/delete/:id', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_model_1.default.deleteOne({ _id: req.params.id }).then(function (data) {
